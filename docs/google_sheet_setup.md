...
4. Exécutez la fonction `createComposerDirectorySheet()`.
5. Autorisez les permissions Google si demandé.
6. Ouvrez l'URL du fichier créée dans les logs (`Logger.log`).
